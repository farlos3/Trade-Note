...
async function getDb() {
  if (!client) {
    // Assign only once connected. Assigning first means a failed connect leaves a
    // dead client cached, and every later call reuses it and fails with
    // "Topology is closed" until the process restarts -- a transient outage
